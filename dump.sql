...
2	1	A pair of leather gauntlets.	1	1
\.
...
43	Basic clothing	Inexpensive		Other	basic-clothing	3	13
\.
...
SELECT pg_catalog.setval('public.cyphercore_characterequipment_id_seq', 8, true);
...
SELECT pg_catalog.setval('public.cyphercore_characterskill_id_seq', 16, true);
...
SELECT pg_catalog.setval('public.django_admin_log_id_seq', 911, true);
