...
370	Mobile Fighter	Enabler	3 Speed	As part of your attack, you can leap on or over obstacles, swing from ropes, run along narrow surfaces, or otherwise move around the battlefield at your normal speed as if such tasks were routine (difficulty 0). You can’t use this ability if your Speed is modified from wearing armor. Enabler.	mobile-fighter	1
...
373	Deflect Attacks	Action	1 Intellect	Using your mind, you protect yourself from incoming attacks. For the next ten minutes, you are trained in Speed defense tasks. Action to initiate.	deflect-attacks	1
...
SELECT pg_catalog.setval('public.cyphercore_ability_id_seq', 400, true);
...
SELECT pg_catalog.setval('public.cyphercore_focusability_id_seq', 233, true);
...
SELECT pg_catalog.setval('public.django_admin_log_id_seq', 962, true);
