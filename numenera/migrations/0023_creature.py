# Generated by Django 2.1.3 on 2018-12-31 19:09
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('numenera', '0022_auto_20181003_0158'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sourcebook', models.ForeignKey(default=1, on_delete=django.db.models.deletion.PROTECT, to='numenera.Sourcebook')),
            ],
            options={
                'ordering': ['name'],
