...
81	Quintar	You are a quintar from the planet Quint. You are basically humanoid but taller, thinner, and blue skinned. Your hands end in three very long fingers. Quintar have five genders, but all quintar prefer to be addressed as a female when speaking to more binary species. Human emotions and sexuality fascinate them, but not because they don’t have such concepts—quintar emotions and sexuality are just very different from those of humans. In general, quintar are more cerebral than other races, valuing knowledge over all else.\r\nQuint is relatively Earthlike, with slightly less gravity but a slightly denser atmosphere.		Cerebral: +4 to your Intellect Pool. Skill: You are trained in one type of knowledge task of your choice.\r\nSkill: Quintar fascination with human behavior decreases the difficulty of all interaction rolls (pleasant or not) with humans by one step.\r\nDifficult Rest: Quintar subtract 2 from all recovery rolls (minimum 1).	quintar	1
...
17	Identifying	slug
18	Initiative	slug
19	Intimidation	slug
20	Jumping	slug
21	Leatherworking	slug
22	Lockpicking	slug
23	Machinery	slug
24	Metalworking	slug
25	Perception	slug
26	Persuasion	slug
27	Philosophy	slug
28	Physics	slug
29	Pickpocketing	slug
30	Piloting	slug
31	Repairing	slug
32	Riding	slug
33	Smashing	slug
...
SELECT pg_catalog.setval('public.cyphercore_ability_id_seq', 182, true);
...
SELECT pg_catalog.setval('public.django_admin_log_id_seq', 642, true);
...
--
-- Name: cyphercore_skill_slug_c6c67cb6; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX cyphercore_skill_slug_c6c67cb6 ON public.cyphercore_skill USING btree (slug);


--
-- Name: cyphercore_skill_slug_c6c67cb6_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX cyphercore_skill_slug_c6c67cb6_like ON public.cyphercore_skill USING btree (slug varchar_pattern_ops);
